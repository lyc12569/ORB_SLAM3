...
int main(int argc, char **argv)
{
    ...
    message_filters::Subscriber<sensor_msgs::Image> left_sub(nh, "/stereo_inertial_publisher/left/image_rect", 1);
    message_filters::Subscriber<sensor_msgs::Image> right_sub(nh, "/stereo_inertial_publisher/right/image_rect", 1);
    ...
    // ros::Publisher PosPub = nh.advertise<geometry_msgs::TwistStamped>("ORB_SLAM3/twist", 5);
...
void ImageGrabber::GrabStereo(const sensor_msgs::ImageConstPtr& msgLeft,const sensor_msgs::ImageConstPtr& msgRight)
{
    ...
    if(do_rectify)
    {
        ...
        ORB_SLAM3::Frame Tcw_SE3f1=mpSLAM->TrackStereo(cv_ptrLeft->image,cv_ptrRight->image,cv_ptrLeft->header.stamp.toSec());
        Sophus::SE3f Tcw_SE3f = Tcw_SE3f1.GetPose();        
